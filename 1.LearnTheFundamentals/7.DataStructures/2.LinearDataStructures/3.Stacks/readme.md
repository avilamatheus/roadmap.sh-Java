...
# Pilha: Implementação em Java / Stack: Java Implementation

## Descrição / Description
**PT-BR**  
Dentro da pasta `code/StackWithLinkedList` você encontrará uma implementação em Java de uma estrutura de dados de pilha, acompanhada de testes unitários e configurada com Maven para facilitar o gerenciamento de dependências e construção do projeto. A Pilha foi implementada usando a LinkedList anteriormente mostrada na seção anterior.
...
**EN-US**  
Inside the `code/StackWithLinkedList` folder you will find a Java implementation of a stack data structure, accompanied by unit tests and configured with Maven to facilitate dependency management and project building. The Stack was implemented using the LinkedList previously shown in the previous section.
